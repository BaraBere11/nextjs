...
import { authenticateUser, registerUser } from '@/lib/authenticate';
...
export default function Register(props){
  ...
  return (
    <>
      ...
      <Card bg="light">
        <Card.Body><h2>Register</h2>Enter your information below:</Card.Body>
      </Card>
      <br />
      <Form onSubmit={handleSubmit}>
        ...
        <br />
        <Form.Group>
          <Form.Label> Re-enter Password:</Form.Label><Form.Control type="password2" value={password2} id="password2" name="password2" onChange={e => setPassword2(e.target.value)} />
        </Form.Group>
        <br />
